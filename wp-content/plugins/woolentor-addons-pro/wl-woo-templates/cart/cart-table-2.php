												   ...
												   $plus_icon  = woolentor_render_icon( $cartopt, 'quantity_plus_icon', 'quantiytplusicon' );
													...
													?>
														<div class="woolentor-cart-product-quantity <?php echo $cartopt['qty_layout_sytle']; ?>">
															<button class="woolentor-cart-product-quantity-btn minus" type="button">
																<?php echo $minus_icon; ?>
															</button>	
													<?php
															echo apply_filters( 'woocommerce_cart_item_quantity', $product_quantity, $cart_item_key, $cart_item );
													?>
															<button class="woolentor-cart-product-quantity-btn plus" type="button">
																<?php echo $plus_icon; ?>
															</button>	
														</div>
													<?php
			...
			<tr>
				<td colspan="<?php echo count( $cartitem ); ?>" class="actions">
					...
					<div class="wl_update_cart_shop">
						...
						?>
						<?php do_action('woolentor_cart_actions'); ?>
					</div>
...
<script type="text/javascript">
	...
	function updateQty(elem){
		...
		var qty = jQuery( elem ).siblings( '.quantity' ).find( '.qty' );
		...
		jQuery(".wl_update_cart_shop input[type=submit]").prop('disabled', false);
	}

	;jQuery(document.body).on( 'updated_wc_div', function($){
		jQuery('.woolentor-cart-product-quantity').on( 'click', '.woolentor-cart-product-quantity-btn.minus, .woolentor-cart-product-quantity-btn.plus', function(e) {
			e.preventDefault();
			updateQty(this);
		});
	});
