    ...
    function __construct(){
        ...
        if( Woolentor_Template_Manager::instance()->edit_with_gutenberg( $checkout_page_id ) ){
            ...
            $widget_options_shipping_method = !empty( $block_settings ) ? [
                'settings' => [
                    'flat_rate_desc' => isset( $block_settings['flat_rate_desc'] ) ? $block_settings['flat_rate_desc'] : '',
                    'local_pickup_desc' => isset( $block_settings['local_pickup_desc'] ) ? $block_settings['local_pickup_desc'] : '',
                    'free_shipping_desc' => isset( $block_settings['free_shipping_desc'] ) ? $block_settings['free_shipping_desc'] : ''
                ]
            ] : null;
        }else{
