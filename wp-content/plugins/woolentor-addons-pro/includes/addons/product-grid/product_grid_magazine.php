...
class Woolentor_Product_Grid_Magazine_Widget extends WooLentor_Product_Grid_Base_Widget {
    ...
    protected function register_layout_controls() {
        $this->start_controls_section(
            ...
            $this->add_control(
                'switcher_tab_style',
                [
                    'label' => esc_html__( 'Tab Style', 'woolentor' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'two',
                    'condition' => [
                        'layout' => 'grid_list_tab',
                    ...
                    'options' => [
                        'one' => esc_html__( 'One', 'woolentor' ),
                        'two' => esc_html__( 'Two', 'woolentor' )
                    ]
                ]
            );

            $this->add_control(
                'switcher_tab_grid_text',
                [
                    'label' => esc_html__( 'Grid Text', 'woolentor' ),
                    'label_block' =>true,
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'Grid View', 'woolentor' ),
                    'placeholder' => esc_html__( 'Grid View', 'woolentor' ),
                    'condition' => [
                        'layout' => 'grid_list_tab',
                        'switcher_tab_style' => 'two',
                    ],
                    'description'=> esc_html__('Grid Button text','woolentor'),
                ]
            );

            $this->add_control(
                'switcher_tab_list_text',
                [
                    'label' => esc_html__( 'List Text', 'woolentor' ),
                    'label_block' =>true,
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'Editorial View', 'woolentor' ),
                    'placeholder' => esc_html__( 'Editorial View', 'woolentor' ),
                    'condition' => [
                        'layout' => 'grid_list_tab',
                        'switcher_tab_style' => 'two',
                    ],
                    'description'=> esc_html__('List Button text','woolentor'),
                ]
            );
    ...
    protected function register_review_style_controls(){
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    'type' => Controls_Manager::SLIDER,
                    'label' => esc_html__( 'Seperator Space', 'woolentor' ),
    ...
    protected function register_add_to_cart_button_style_controls() {
        ...
        $this->register_view_switcher_style_controls();

        $this->start_controls_section(
            'section_style_cart_action_button',
            [
                'label' => esc_html__( 'Add To Cart Button (Grid View)', 'woolentor' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Add To Cart Button (List View)', 'woolentor' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_add_to_cart' => 'yes',
                    'layout' => ['list', 'grid_list_tab'],
    ...
    protected function register_view_switcher_style_controls() {
        $this->start_controls_section(
            'section_view_switcher_style',
            [
                'label' => esc_html__( 'View Mode Switcher', 'woolentor' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'layout' => ['grid_list_tab'],
                    'switcher_tab_style' => 'two',
            ...
            $this->add_control(
                'switcher_area_background_color',
                [
                    'label' => esc_html__( 'Background Color', 'woolentor' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-product-filters.woolentor-style-two' => 'background:{{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                Group_Control_Border::get_type(),
                [
                    'name' => 'switcher_area_border',
                    'selector' => '{{WRAPPER}} .woolentor-product-filters.woolentor-style-two',
                ]
            );

            $this->add_control(
                'switcher_area_border_radius',
                [
                    'label' => esc_html__( 'Border Radius', 'woolentor' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-product-filters.woolentor-style-two' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );

            $this->add_responsive_control(
                'switcher_area_padding',
                [
                    'label' => esc_html__( 'Padding', 'woolentor' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-product-filters.woolentor-style-two' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );

            $this->add_responsive_control(
                'switcher_area_margin',
                [
                    'label' => esc_html__( 'Margin', 'woolentor' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-product-filters.woolentor-style-two' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );

            $this->add_control(
                'switcher_button_style_heading',
                [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-style-two .woolentor-layout-btn' => 'color: {{VALUE}};',
                    ],
                ]
            );

            $this->add_control(
                'view_switcher_border_color',
                [
                    'label' => esc_html__( 'Border Color', 'woolentor' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-style-two .woolentor-layout-btn.woolentor-active::after' => 'background: {{VALUE}};',
                    ],
                ]
            );

            $this->add_control(
                'view_switcher_hover_color',
                [
                    'label' => esc_html__( 'Hover Color', 'woolentor' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-style-two .woolentor-layout-btn:hover' => 'color: {{VALUE}};',
                        '{{WRAPPER}} .woolentor-style-two .woolentor-layout-btn.woolentor-active' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(),
                [
                    'name' => 'view_switcher_typography',
                    'selector' => '{{WRAPPER}} .woolentor-style-two .woolentor-layout-btn',
                ]
            );
    ...
    protected function register_button_style_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Quick Action Button (Grid View)', 'woolentor' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Quick Action Button (List View)', 'woolentor' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_quick_actions' => 'yes',
                    'layout' => ['list', 'grid_list_tab'],
    ...
    protected function prepare_grid_settings( $settings ) {
        ...
        $magazine_settings = [
            ...
            'switcher_tab_style'        => $get_val('switcher_tab_style', 'two'),
            'switcher_tab_grid_text'    => $get_val('switcher_tab_grid_text', esc_html__( 'Grid View', 'woolentor' )),
            'switcher_tab_list_text'    => $get_val('switcher_tab_list_text', esc_html__( 'Editorial View', 'woolentor' )),
        ];
