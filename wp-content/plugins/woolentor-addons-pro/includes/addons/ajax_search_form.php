...
class Woolentor_Ajax_Search_Form_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'search_form_area_order_radius',
                [
                    'label' => __( 'Border Radius', 'woolentor-pro' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor_widget_psa_field_area' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    'name' => 'search_form_area_background_color',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Input Box Area', 'woolentor-pro' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
            ...
            $this->add_group_control(
                Group_Control_Border::get_type(),
                [
                    'name' => 'search_input_box_area_border',
                    'label' => __( 'Border', 'woolentor-pro' ),
                    'selector' => '{{WRAPPER}} .woolentor_widget_psa_input_area',
                    'separator' =>'before',
                ]
            );

            $this->add_responsive_control(
                'search_input_box_area_border_radius',
                [
                    'label' => __( 'Border Radius', 'woolentor-pro' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor_widget_psa_input_area' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );

            $this->add_responsive_control(
                'search_input_box_area_padding',
                [
                    'label' => __( 'Padding', 'woolentor-pro' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor_widget_psa_input_area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );

            $this->add_responsive_control(
                'search_input_box_area_margin',
                [
                    'label' => __( 'Margin', 'woolentor-pro' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor_widget_psa_input_area' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_group_control(
                Group_Control_Background::get_type(),
                [
                    'name' => 'search_input_box_area_background_color',
                    'types' => [ 'classic', 'gradient' ],
                    'exclude' => ['image'],
                    'fields_options'=>[
                        'background'=>[
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'search_form_category_dropdown_position',
                [
                    ...
                    'default' => 'row',
                    'selectors' => [
                        '{{WRAPPER}} .woolentor_widget_psa .woolentor_widget_psa_field_area' => 'flex-direction: {{VALUE}};'
                    ]
                ]
            );
            ...
            $this->add_responsive_control(
                'category_dropdown_right_border_hide',
                [
                    'label' => esc_html__( 'Hide Right Border', 'woolentor' ),
                    'type' => Controls_Manager::CHOOSE,
                    'toggle' => false,
                    'options' => [
                        'none' => [
                            'title' => esc_html__( 'Hide', 'woolentor' ),
                            'icon' => 'eicon-editor-close',
                        ],
                        'block' => [
                            'title' => esc_html__( 'Show', 'woolentor' ),
                            'icon' => 'eicon-preview-thin',
                        ]
                    ],
                    'default' => 'block',
                    'selectors' => [
                        '{{WRAPPER}} .woolentor_widget_psa_category::after' => 'display: {{VALUE}};'
                    ]
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'condition'=>[
                        'category_dropdown_right_border_hide' => 'block'
                    ]
                ]
            );
            ...
            $this->add_group_control(
                Group_Control_Border::get_type(),
                [
                    'name' => 'category_dropdown_area_border',
                    'label' => __( 'Border', 'woolentor-pro' ),
                    'selector' => '{{WRAPPER}} .woolentor_widget_psa_category',
                    'separator' =>'before',
                ]
            );

            $this->add_responsive_control(
                'category_dropdown_area_order_radius',
                [
                    'label' => __( 'Border Radius', 'woolentor-pro' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor_widget_psa_category' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );

            $this->add_responsive_control(
                'category_dropdown_area_padding',
                [
                    'label' => __( 'Padding', 'woolentor-pro' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor_widget_psa_category' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );

            $this->add_responsive_control(
                'category_dropdown_area_margin',
                [
                    'label' => __( 'Margin', 'woolentor-pro' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor_widget_psa_category' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                Group_Control_Background::get_type(),
                [
                    'name' => 'category_dropdown_area_background_color',
                    'types' => [ 'classic', 'gradient' ],
                    'exclude' => ['image'],
                    'fields_options'=>[
                        'background'=>[
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default' => 'row',
                    'selectors' => [
                        '{{WRAPPER}} .woolentor_widget_psa .woolentor_widget_psa_input_area' => 'flex-direction: {{VALUE}};'
                    ]
                ]
            );
