            ...
            'fields'   => array(
                ...
                array(
                    ...
                    'options'  => array(
                        ...
                        '4' => esc_html__( 'Style 4', 'woolentor-pro' ),
                        '5' => esc_html__( 'Style 5', 'woolentor-pro' ),
                        '6' => esc_html__( 'Style 6', 'woolentor-pro' ),
                    )
                ),
                ...
                array(
                    'id'          => 'product',
                    'title'       => esc_html__( 'Select Product', 'woolentor-pro' ),
                    'desc'        => esc_html__( 'Choose the product you want to offer as an order bump.', 'woolentor-pro' ),
                    'type'        => 'select',
