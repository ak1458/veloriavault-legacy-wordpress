...
if ( ! function_exists( 'woodmart_wpml_js_data' ) ) {
	...
	add_action( 'woodmart_page_bottom_part', 'woodmart_wpml_js_data', 12 );
}
...
if ( ! function_exists( 'woodmart_wpml_set_global_product' ) ) {
	...
	if ( ! function_exists( 'woodmart_wpml_enable_ajax_ls' ) ) {
		function woodmart_wpml_enable_ajax_ls( $enabled ) {
		...
		add_filter( 'wpml_ls_enable_ajax_navigation', 'woodmart_wpml_enable_ajax_ls', 10, 1 );
	}
